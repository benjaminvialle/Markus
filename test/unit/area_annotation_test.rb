...
class AreaAnnotationTest < ActiveSupport::TestCase
  ...
  def test_extract_coords
    basic_annot = AreaAnnotation.make({:x1 => 0, :x2 => 10, :y1 => 0, :y2 => 10})
    negative_annot = AreaAnnotation.make({:x1 => -1, :x2 => 3, :y1 => -2, :y2 => 5})
    spaces_annot = AreaAnnotation.make({:x1 => -1, :x2 => 3, :y1 => 123, :y2 => 5})
