...
namespace :markus do
 ...
 "start generating assignment #" + curr_assignment_num.to_s + "... "
	...
	assignment.description = "Conditionals and Loops"
        ...
        assignment.repository_folder = "A1" 
	...
	group = Group.create
	group.set_repo_name
	curr_group_num_for_name=1
        while (Group.find_by_group_name(group.group_name)) do
          	curr_group_num_for_name += 1
         	group.group_name = "Group" + curr_group_num_for_name.to_s
        end
	group.save
	...
	submission.grouping_id=grouping.id
	submission.submission_version=rand(100)
	submission.revision_number=rand(1000)
